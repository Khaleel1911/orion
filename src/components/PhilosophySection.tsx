...
//       {/* ── MAIN LAYOUT ── */}
//       <div
//         className="relative max-w-7xl mx-auto px-6 lg:px-16 mt-10"
//         style={{
...
//         {/* ── FLOATING STAT TILES — anchored bottom-right of image ── */}
//         <div
//           style={{
//             position: "absolute",
...
//         /* Mobile: collapse stat tiles, full-width text */
//         @media (max-width: 640px) {
//           .phi-stat-group { display: none !important; }
//         }
//       `}</style>
//     </section>
//   )
